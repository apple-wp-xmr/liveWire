<tr class="border-b hover:bg-gray-50">
    ...
    <td class="px-6 py-4">
        <x-dialog wire:model="showEditDiaolg">
            <x-dialog.button>
                <button type="button"
                    class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-offset-2 transition">
                    Edit
                </button>
            </x-dialog.button>
            <x-dialog.panel>
