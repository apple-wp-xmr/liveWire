<template x-teleport='body'>
    ...
    <div x-dialog x-model="open" style="display: none" class="fixed inset-0 overflow-y-auto z-10">
        ...
        <!-- Panel -->
        <div class="relative min-h-screen flex sm:items-center items-end justify-center sm:p-4 ">
            <div x-dialog:panel x-transition.in x-transition.out.opacity
                ...
                <div class="absolute top-0 right-0 pt-4 pr-4">
                    <button type="button" @click="$dialog.close()" class="bg-gray rounded-lg p-2 text-gray-600">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            height="20px" width="20px" version="1.1" id="Capa_1" viewBox="0 0 26 26"
                            xml:space="preserve">
                            <g>
